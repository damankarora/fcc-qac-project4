...
suite('UnitTests', () => {
    suite('Testing Validate method', ()=>{
        ...
        test('Logic handles a puzzle string that is not 81 characters in length', () => {
            assert.throws(() => { solver.validate('1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37..') }, "Expected puzzle to be 81 characters long");
        })

        test('Logic handles a puzzle string with invalid characters (not 1-9 or .)', ()=>{
            assert.throws(() => { solver.validate('1.5..2.84..B3.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.') }, "Invalid characters in puzzle");
        });
    });
